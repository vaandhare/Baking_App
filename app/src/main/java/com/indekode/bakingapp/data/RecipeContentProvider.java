    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (match) {
            case CODE_LIST_WIDGET:
                cursor = db.query(IngredientsEntry.TABLE_NAME, projection,
                        selection, selectionArgs, null, null, sortOrder);
                break;

            case CODE_LIST_WIDGET_ITEM:
                String[] args = {uri.getLastPathSegment()};
                cursor = db.query(IngredientsEntry.TABLE_NAME, projection, IngredientsEntry.COLUMN_RECIPE_ID + "=?",
    ...
    public int update(@NonNull Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            ...
            case CODE_LIST_WIDGET_ITEM:
                ...
                numberOfRowsUpdated = sqLiteDatabase.update(IngredientsEntry.TABLE_NAME,
                        values, IngredientsEntry.COLUMN_RECIPE_ID + "=?", args);
                break;
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
        }
